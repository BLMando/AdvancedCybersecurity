...
def provision_mongo_user(service: PKIService, logger: logging.Logger, username: str, role: str) -> None:
    ...
    try:
        ...
        try:
            ...
            pass
        try:
            db_external.command("createUser", oidc_username, roles=[{"role": mongo_role, "db": MONGO_DB}])
...
def prepare_combined_pem(
    service: PKIService, user_cn: str, cert_path: str, key_path: str, jwt_token: str | None
) -> str:
